...
/**
Manager de l ' entité Certificats
@author Nom Prenom (email) 
*/
public class CertificatsManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		Certificats certificats = (Certificats) entite;

		 certificats.setDateCreation(DateUtile.dateCalendarCourante());
