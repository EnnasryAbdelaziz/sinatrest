...
/**
Manager de l ' entité NatureProthese
@author Nom Prenom (email) 
*/
public class NatureProtheseManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		NatureProthese natureProthese = (NatureProthese) entite;

		 natureProthese.setDateCreation(DateUtile.dateCalendarCourante());



		return natureProthese;
