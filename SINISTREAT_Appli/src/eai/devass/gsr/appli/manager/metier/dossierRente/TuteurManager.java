...
/**
Manager de l ' entité Tuteur
@author Nom Prenom (email) 
*/
public class TuteurManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		Tuteur tuteur = (Tuteur) entite;

		 tuteur.setDateCreation(DateUtile.dateCalendarCourante());
