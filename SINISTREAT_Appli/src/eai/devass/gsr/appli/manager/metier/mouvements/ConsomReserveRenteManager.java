...
/**
Manager de l ' entité ConsomReserveRente
@author Nom Prenom (email) 
*/
public class ConsomReserveRenteManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		ConsomReserveRente consomReserveRente = (ConsomReserveRente) entite;

		 consomReserveRente.setDateCreation(DateUtile.dateCalendarCourante());



		return consomReserveRente;
