...
/**
Manager de l ' entité MvtConsignCNRA
@author Nom Prenom (email) 
*/
public class MvtConsignCNRAManager extends MouvementManager {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		...
		Calendar toDaye = DateUtile.dateCalendarCourante();
		mouvement.setDatEtat(toDaye);
		mouvement.setDateCreation(toDaye);
		return mouvement;
...
*/
	protected IEntite habiller(IEntite entite) throws EntiteException {
		MvtConsignCNRA mvtConsignCNRA = (MvtConsignCNRA) super.habiller(entite);
		return mvtConsignCNRA;	
	}
/**
...
protected IEntite doProcessModifyEntity(IEntite entite)
	...
	MvtConsignCNRA mvtConsignCNRA = (MvtConsignCNRA) entite;
