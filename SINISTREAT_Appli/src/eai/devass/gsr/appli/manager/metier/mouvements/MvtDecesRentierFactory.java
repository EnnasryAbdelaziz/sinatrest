...
/**
Factory de l' Entité MvtDecesRentier
@author Nom Prenom (email)
*/
public class MvtDecesRentierFactory extends EntiteFactory {
...
*/
	public IEntiteManager newEntiteManager() {
		return new MvtDecesRentierManager();
	}
