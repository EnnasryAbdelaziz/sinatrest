...
/**
Manager de l ' entité MvtDecesRentier
@author Nom Prenom (email) 
*/
public class MvtDecesRentierManager extends MouvementManager {
...
*/
	protected IEntite habiller(IEntite entite) throws EntiteException {
		MvtDecesRentier mvtDecesRentier = (MvtDecesRentier) super.habiller(entite);
		return mvtDecesRentier;	
	}
/**
...
protected IEntite doProcessModifyEntity(IEntite entite)
	...
	MvtDecesRentier mvtDecesRentier = (MvtDecesRentier) entite;
