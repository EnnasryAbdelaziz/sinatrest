...
/**
Factory de l' Entité MvtDefautRemise
@author Nom Prenom (email)
*/
public class MvtDefautRemiseFactory extends EntiteFactory {
...
*/
	public IEntiteManager newEntiteManager() {
		return new MvtDefautRemiseManager();
	}
