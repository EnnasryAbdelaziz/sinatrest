...
/**
Manager de l ' entité MvtRachat
@author Nom Prenom (email) 
*/
public class MvtRachatManager extends MouvementManager {
...
//		MvtRachat mvtRachat = (MvtRachat) entite;
//
//		 mvtRachat.setDateCreation(DateUtile.dateCalendarCourante());
//
//
//
//		return mvtRachat;
...
*/
	protected IEntite habiller(IEntite entite) throws EntiteException {
		MvtRachat mvtRachat = (MvtRachat) super.habiller(entite);
		return mvtRachat;	
	}
/**
