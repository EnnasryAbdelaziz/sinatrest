...
/**
Manager de l ' entité MvtRemiseEnCours
@author Nom Prenom (email) 
*/
public class MvtRemiseEnCoursManager extends MouvementManager {
...
*/
	protected IEntite habiller(IEntite entite) throws EntiteException {
		MvtRemiseEnCours mvtRemiseEnCours = (MvtRemiseEnCours) super.habiller(entite);
		return mvtRemiseEnCours;	
	}
/**
...
protected IEntite doProcessModifyEntity(IEntite entite)
	...
	MvtRemiseEnCours mvtRemiseEnCours = (MvtRemiseEnCours) entite;
