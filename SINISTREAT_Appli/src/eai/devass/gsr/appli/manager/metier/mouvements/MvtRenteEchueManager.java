...
/**
Manager de l ' entité MvtRenteEchue
@author Nom Prenom (email) 
*/
public class MvtRenteEchueManager extends MouvementManager {
...
//		if (((MvtRenteEchue)entite).getRefMotifRenteEchue() == null){
//		    	ValidateEntiteException ve = new ValidateEntiteException ("FIELD.OBLIGATOIRE");
//				ve.setValues(new String []{"motifRenteEchue"});
//				throw ve;
//		    	
//		  	}
...
//		MvtRenteEchue mvtRenteEchue = (MvtRenteEchue) super.habiller(entite);
//
//
//		
//		MotifRenteEchue refMotifRenteEchue1 = mvtRenteEchue.getRefMotifRenteEchue();
//		MotifRenteEchue refMotifRenteEchue = new MotifRenteEchue();
//
//		
//		if (refMotifRenteEchue1 != null)
//		    ((IEntite)refMotifRenteEchue).setId(refMotifRenteEchue1.getId());
//		if(refMotifRenteEchue!=null && refMotifRenteEchue1 != null){
//			if (((IEntite)refMotifRenteEchue).getId()!=0){
//				    refMotifRenteEchue =(MotifRenteEchue)(new MotifRenteEchue()).getFactory().newEntiteManager().getEntite((MotifRenteEchue)refMotifRenteEchue);
//				mvtRenteEchue.setRefMotifRenteEchue(refMotifRenteEchue);
//			}
//			else {
//				mvtRenteEchue.setRefMotifRenteEchue(refMotifRenteEchue1);
//			}
//		}		
//		return mvtRenteEchue;	
//	}
/**
...
protected IEntite doProcessModifyEntity(IEntite entite)
	...
	MvtRenteEchue mvtRenteEchue = (MvtRenteEchue) entite;
