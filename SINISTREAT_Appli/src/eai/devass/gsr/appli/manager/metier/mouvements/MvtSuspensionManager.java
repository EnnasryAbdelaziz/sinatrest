...
/**
Manager de l ' entité MvtSuspension
@author Nom Prenom (email) 
*/
public class MvtSuspensionManager extends MouvementManager {
...
//		MvtSuspension mvtSuspension = (MvtSuspension) entite;
//
//		 mvtSuspension.setDateCreation(DateUtile.dateCalendarCourante());
//
//
//
//		return mvtSuspension;
//
//	}
...
*/
	protected IEntite habiller(IEntite entite) throws EntiteException {
		MvtSuspension mvtSuspension = (MvtSuspension) super.habiller(entite);
		return mvtSuspension;	
	}
/**
