...
*/
public class ModePayementManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		ModePayement modePayement = (ModePayement) entite;

		 modePayement.setDateCreation(DateUtile.dateCalendarCourante());
