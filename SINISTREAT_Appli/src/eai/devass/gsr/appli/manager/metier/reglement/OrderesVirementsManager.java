...
/**
Manager de l ' entité OrderesVirements
@author Nom Prenom (email) 
*/
public class OrderesVirementsManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		OrderesVirements orderesVirements = (OrderesVirements) entite;

		 orderesVirements.setDateCreation(DateUtile.dateCalendarCourante());



		return orderesVirements;
