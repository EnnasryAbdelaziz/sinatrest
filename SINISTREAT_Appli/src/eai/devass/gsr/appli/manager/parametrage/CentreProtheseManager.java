...
/**
Manager de l ' entité CentreProthese
@author Nom Prenom (email) 
*/
public class CentreProtheseManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		CentreProthese centreProthese = (CentreProthese) entite;

		 centreProthese.setDateCreation(DateUtile.dateCalendarCourante());



		return centreProthese;
