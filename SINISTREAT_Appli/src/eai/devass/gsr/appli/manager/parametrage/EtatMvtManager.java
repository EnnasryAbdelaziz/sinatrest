...
/**
Manager de l ' entité EtatMvt
@author Nom Prenom (email) 
*/
public class EtatMvtManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		EtatMvt etatMvt = (EtatMvt) entite;

		 etatMvt.setDateCreation(DateUtile.dateCalendarCourante());
