...
/**
Manager de l ' entité EtatQtc
@author Nom Prenom (email) 
*/
public class EtatQtcManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		EtatQtc etatQtc = (EtatQtc) entite;

		 etatQtc.setDateCreation(DateUtile.dateCalendarCourante());
