...
/**
Manager de l ' entité EtatRentier
@author Nom Prenom (email) 
*/
public class EtatRentierManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		EtatRentier etatRentier = (EtatRentier) entite;

		 etatRentier.setDateCreation(DateUtile.dateCalendarCourante());
