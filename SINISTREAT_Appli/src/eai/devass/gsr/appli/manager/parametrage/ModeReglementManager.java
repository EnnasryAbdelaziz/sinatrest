...
/**
Manager de l ' entité ModeReglement
@author Nom Prenom (email) 
*/
public class ModeReglementManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		ModeReglement modeReglement = (ModeReglement) entite;

		 modeReglement.setDateCreation(DateUtile.dateCalendarCourante());
