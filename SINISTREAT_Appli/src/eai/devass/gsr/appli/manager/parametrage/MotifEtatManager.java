...
/**
Manager de l ' entité MotifEtat
@author Nom Prenom (email) 
*/
public class MotifEtatManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		MotifEtat motifEtat = (MotifEtat) entite;

		 motifEtat.setDateCreation(DateUtile.dateCalendarCourante());
