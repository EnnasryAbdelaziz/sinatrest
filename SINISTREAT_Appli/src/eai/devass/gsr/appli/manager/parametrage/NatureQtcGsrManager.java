...
/**
Manager de l ' entité NatureQuittance
@author Nom Prenom (email) 
*/
public class NatureQtcGsrManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		NatureQtcGsr natureQuittance = (NatureQtcGsr) entite;

		 natureQuittance.setDateCreation(DateUtile.dateCalendarCourante());
