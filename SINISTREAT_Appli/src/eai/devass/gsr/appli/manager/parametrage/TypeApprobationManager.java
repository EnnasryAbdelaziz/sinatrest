...
/**
Manager de l ' entité TypeApprobation
@author Nom Prenom (email) 
*/
public class TypeApprobationManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		TypeApprobation typeApprobation = (TypeApprobation) entite;

		 typeApprobation.setDateCreation(DateUtile.dateCalendarCourante());



		return typeApprobation;
