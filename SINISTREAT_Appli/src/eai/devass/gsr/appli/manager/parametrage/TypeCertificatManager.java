...
/**
Manager de l ' entité TypeCertificat
@author Nom Prenom (email) 
*/
public class TypeCertificatManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		TypeCertificat typeCertificat = (TypeCertificat) entite;

		 typeCertificat.setDateCreation(DateUtile.dateCalendarCourante());
