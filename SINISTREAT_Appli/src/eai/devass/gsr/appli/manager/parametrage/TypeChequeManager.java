...
/**
Manager de l ' entité TypeCheque
@author Nom Prenom (email) 
*/
public class TypeChequeManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		TypeCheque typeCheque = (TypeCheque) entite;

		 typeCheque.setDateCreation(DateUtile.dateCalendarCourante());
