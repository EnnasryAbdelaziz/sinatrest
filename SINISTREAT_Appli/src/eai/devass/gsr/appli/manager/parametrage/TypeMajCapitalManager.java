...
/**
Manager de l ' entité TypeMajCapital
@author Nom Prenom (email) 
*/
public class TypeMajCapitalManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		TypeMajCapital typeMajCapital = (TypeMajCapital) entite;

		 typeMajCapital.setDateCreation(DateUtile.dateCalendarCourante());



		return typeMajCapital;
