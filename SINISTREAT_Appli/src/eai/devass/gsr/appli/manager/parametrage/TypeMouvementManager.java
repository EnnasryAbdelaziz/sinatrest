...
/**
Manager de l ' entité TypeMouvement
@author Nom Prenom (email) 
*/
public class TypeMouvementManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		TypeMouvement typeMouvement = (TypeMouvement) entite;

		 typeMouvement.setDateCreation(DateUtile.dateCalendarCourante());
