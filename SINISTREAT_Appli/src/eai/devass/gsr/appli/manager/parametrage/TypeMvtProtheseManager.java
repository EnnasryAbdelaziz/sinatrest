...
/**
Manager de l ' entité TypeMvtProthese
@author Nom Prenom (email) 
*/
public class TypeMvtProtheseManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		TypeMvtProthese typeMvtProthese = (TypeMvtProthese) entite;

		 typeMvtProthese.setDateCreation(DateUtile.dateCalendarCourante());



		return typeMvtProthese;
