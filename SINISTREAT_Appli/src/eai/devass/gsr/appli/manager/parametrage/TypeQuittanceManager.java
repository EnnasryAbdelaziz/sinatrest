...
/**
Manager de l ' entité TypeQuittance
@author Nom Prenom (email) 
*/
public class TypeQuittanceManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		TypeQuittance typeQuittance = (TypeQuittance) entite;

		 typeQuittance.setDateCreation(DateUtile.dateCalendarCourante());
