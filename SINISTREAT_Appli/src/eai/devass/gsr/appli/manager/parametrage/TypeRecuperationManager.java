...
/**
Manager de l ' entité TypeRecuperation
@author Nom Prenom (email) 
*/
public class TypeRecuperationManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		TypeRecuperation typeRecuperation = (TypeRecuperation) entite;

		 typeRecuperation.setDateCreation(DateUtile.dateCalendarCourante());



		return typeRecuperation;
