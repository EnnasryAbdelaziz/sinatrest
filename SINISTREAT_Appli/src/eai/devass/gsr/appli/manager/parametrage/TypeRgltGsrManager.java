...
/**
Manager de l ' entité TypeReglement
@author Nom Prenom (email) 
*/
public class TypeRgltGsrManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		TypeRgltGsr typeReglement = (TypeRgltGsr) entite;

		 typeReglement.setDateCreation(DateUtile.dateCalendarCourante());
