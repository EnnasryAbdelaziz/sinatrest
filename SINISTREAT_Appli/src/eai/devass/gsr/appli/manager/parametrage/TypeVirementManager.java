...
/**
Manager de l ' entité TypeVirement
@author Nom Prenom (email) 
*/
public class TypeVirementManager extends EntiteManagerAbst {
...
*/
	protected IEntite doProcessCreateEntity(IEntite entite) throws ProcessEntiteException, EntiteException {
		TypeVirement typeVirement = (TypeVirement) entite;

		 typeVirement.setDateCreation(DateUtile.dateCalendarCourante());
