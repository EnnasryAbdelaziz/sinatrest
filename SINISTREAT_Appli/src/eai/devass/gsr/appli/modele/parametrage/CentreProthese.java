...
import eai.devass.gsr.appli.manager.parametrage.CentreProtheseFactory;
...
*/
@AConverter(entiteMapping="eai.devass.gsr.appli.valueobjects.parametrage.CentreProtheseVO")
public class CentreProthese implements IEntite, ILockable          {
...
*/
	public EntiteFactory getFactory() {
		return new CentreProtheseFactory();
	}
