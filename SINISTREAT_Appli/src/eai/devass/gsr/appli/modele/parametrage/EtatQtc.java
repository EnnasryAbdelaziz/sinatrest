...
import eai.devass.gsr.appli.manager.parametrage.EtatQtcFactory;
...
@AConverter(entiteMapping="eai.devass.gsr.appli.valueobjects.parametrage.EtatQtcVO")
public class EtatQtc implements IEntite, ILockable {
