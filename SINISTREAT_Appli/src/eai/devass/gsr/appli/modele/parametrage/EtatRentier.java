...
*/
@AConverter(entiteMapping="eai.devass.gsr.appli.valueobjects.parametrage.EtatRentierVO")
public class EtatRentier implements IEntite, ILockable          {
