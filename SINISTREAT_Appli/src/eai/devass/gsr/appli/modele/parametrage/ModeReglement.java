...
import eai.devass.gsr.appli.manager.parametrage.ModeReglementFactory;
 ...
 */
@AConverter(entiteMapping="eai.devass.gsr.appli.valueobjects.parametrage.ModeReglementVO")
public class ModeReglement implements IEntite, ILockable {
	...
	public EntiteFactory getFactory() {
		return new ModeReglementFactory();
	}
