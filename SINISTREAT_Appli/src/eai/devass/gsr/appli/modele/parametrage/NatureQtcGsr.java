...
import eai.devass.gsr.appli.manager.parametrage.NatureQtcGsrFactory;
...
@AConverter(entiteMapping="eai.devass.gsr.appli.valueobjects.parametrage.NatureQtcGsrVO")
public class NatureQtcGsr implements IEntite, ILockable {
	...
	public EntiteFactory getFactory() {
		return new NatureQtcGsrFactory();
	}
