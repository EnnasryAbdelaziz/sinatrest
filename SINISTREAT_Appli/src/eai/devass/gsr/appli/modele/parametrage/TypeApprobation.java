...
import eai.devass.gsr.appli.manager.parametrage.TypeApprobationFactory;
...
@AConverter(entiteMapping="eai.devass.gsr.appli.valueobjects.parametrage.TypeApprobationVO")
public class TypeApprobation implements IEntite, ILockable {
	...
	public EntiteFactory getFactory() {
		return new TypeApprobationFactory();
	}
	
	

	public TypeApprobation() {
		super();
	}
	
	public TypeApprobation(long id) {
		super();
		this.id = id;
	}
