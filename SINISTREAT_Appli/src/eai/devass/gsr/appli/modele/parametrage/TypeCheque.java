...
import eai.devass.gsr.appli.manager.parametrage.TypeChequeFactory;
...
@AConverter(entiteMapping = "eai.devass.gsr.appli.valueobjects.parametrage.TypeChequeVO")
public class TypeCheque implements IEntite, ILockable {
