...
import eai.devass.gsr.appli.manager.parametrage.TypeMajCapitalFactory;
...
*/
public class TypeMajCapital implements IEntite, ILockable          {
...
*/
	public EntiteFactory getFactory() {
		return new TypeMajCapitalFactory();
	}
