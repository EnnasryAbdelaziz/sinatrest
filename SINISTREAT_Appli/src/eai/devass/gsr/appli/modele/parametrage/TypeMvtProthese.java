...
import eai.devass.gsr.appli.manager.parametrage.TypeMvtProtheseFactory;
...
/**
 type mouvement prothese:  
@author Nom Prenom (email)
*/
@AConverter(entiteMapping="eai.devass.gsr.appli.valueobjects.parametrage.TypeMvtProtheseVO")
public class TypeMvtProthese implements IEntite, ILockable          {
...
*/
	public EntiteFactory getFactory() {
		return new TypeMvtProtheseFactory();
	}
