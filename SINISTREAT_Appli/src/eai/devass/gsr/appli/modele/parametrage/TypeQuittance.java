...
import eai.devass.gsr.appli.manager.parametrage.TypeQuittanceFactory;
...
@AConverter(entiteMapping="eai.devass.gsr.appli.valueobjects.parametrage.TypeQuittanceVO")
public class TypeQuittance implements IEntite, ILockable {
	...
	public EntiteFactory getFactory() {
		return new TypeQuittanceFactory();
	}
