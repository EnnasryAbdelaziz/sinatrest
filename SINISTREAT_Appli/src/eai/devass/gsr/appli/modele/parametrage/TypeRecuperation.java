...
import eai.devass.gsr.appli.manager.parametrage.TypeRecuperationFactory;
...
*/
public class TypeRecuperation implements IEntite, ILockable          {
...
*/
	public EntiteFactory getFactory() {
		return new TypeRecuperationFactory();
	}
