...
import eai.devass.gsr.appli.manager.parametrage.TypeRgltGsrFactory;
...
@AConverter(entiteMapping = "eai.devass.gsr.appli.valueobjects.parametrage.TypeRgltGsrVO")
public class TypeRgltGsr implements IEntite, ILockable {
