...
import eai.devass.gsr.appli.manager.parametrage.TypeVirementFactory;
...
@AConverter(entiteMapping="eai.devass.gsr.appli.valueobjects.parametrage.TypeVirementVO")
public class TypeVirement implements IEntite, ILockable          {
...
*/
	public EntiteFactory getFactory() {
		return new TypeVirementFactory();
	}
