...
public class EditerEtatDefautsCertificatRemariage extends EditerEtatUC{
	
	@Override
	protected String getCodeRapport() {

		return IConstantes.CODE_RAPPORT_ETAT_DEFAUTS_CERTIFICAT_REMARIAGE;
	}
	...
	protected Map<String, Object> getRapportParametresValues(IValueObject vo) {
		...
		params.put("anneeRef", editionVO.getAnneeRef());
		params.put("anneeRef1", editionVO.getAnneeRef1());
		params.put("libelleTypeCertificat", "Remariage");
