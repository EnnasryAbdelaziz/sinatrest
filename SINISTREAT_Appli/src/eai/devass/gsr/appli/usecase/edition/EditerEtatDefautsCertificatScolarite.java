...
public class EditerEtatDefautsCertificatScolarite extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {

		return IConstantes.CODE_RAPPORT_ETAT_DEFAUTS_CERTIFICAT_SCOLARITE;
	}
	...
	protected Map<String, Object> getRapportParametresValues(IValueObject vo) {
		...
		params.put("libelleTypeCertificat", "Scolarité");
