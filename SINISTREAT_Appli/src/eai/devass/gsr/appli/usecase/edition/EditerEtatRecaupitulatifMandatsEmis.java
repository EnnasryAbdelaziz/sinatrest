...
public class EditerEtatRecaupitulatifMandatsEmis extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_ETAT_MANDATS_EMIS;
	}

	@Override
	protected Map<String, Object> getRapportParametresValues(IValueObject vo) {
		String titre = "Etat récaupitulatif des Mandats emis par bénéficiaire : ";
