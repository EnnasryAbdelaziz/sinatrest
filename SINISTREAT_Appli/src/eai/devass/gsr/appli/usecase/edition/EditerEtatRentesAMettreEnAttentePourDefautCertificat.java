...
public class EditerEtatRentesAMettreEnAttentePourDefautCertificat extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_RAPPORT_ETAT_RENTES_AMETTRE_EN_ATTENTE_POUR_DEFAUT_CERTIFICAT;
	}
