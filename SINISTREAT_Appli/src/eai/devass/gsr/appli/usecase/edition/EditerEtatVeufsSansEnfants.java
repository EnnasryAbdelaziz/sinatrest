...
public class EditerEtatVeufsSansEnfants extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_RAPPORT_ETAT_VEUFS_SANS_ENFANTS;
	}
	...
	protected Map<String, Object> getRapportParametresValues(IValueObject vo) {
		...
		params.put("ageMin", editionVO.getAgeMin());
		params.put("ageMax", editionVO.getAgeMax());
		return params;
	}
}
