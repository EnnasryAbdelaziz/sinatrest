...
*/
public class CertificatsModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		Certificats lToUpdate = (Certificats) this.getItem(Certificats.class);
		Certificats lUpdated = (Certificats) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
