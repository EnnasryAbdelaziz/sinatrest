...
*/
public class DossierRenteAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		DossierRente lToCreate = (DossierRente) this.getItem(DossierRente.class);
		// Ici Je persiste l' entite DossierRente au niveau de la base de donnees
		DossierRente lCreated = (DossierRente) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
