...
public class DossierRenteRechercherUCConverter extends RechListeVOConverter {
...
*/	
	protected Object convertItemtoVOItem(Object item) {
		...
		dossierRenteVOConverter.itemToVo(vo, (DossierRente)item, null);
		return vo;
	}
/**
...
*/			
	public List<DossierRente> convertValueObjectToItems(Object ovo) throws ValidationException {
