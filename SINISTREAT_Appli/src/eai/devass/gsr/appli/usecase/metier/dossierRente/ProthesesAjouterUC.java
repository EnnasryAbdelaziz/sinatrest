...
*/
public class ProthesesAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		Prothese lToCreate = (Prothese) this.getItem(Prothese.class);
		// Ici Je persiste l' entite Protheses au niveau de la base de donnees
		Prothese lCreated = (Prothese) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
