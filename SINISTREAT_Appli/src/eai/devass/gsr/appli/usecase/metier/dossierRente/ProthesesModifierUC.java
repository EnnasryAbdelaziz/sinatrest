...
*/
public class ProthesesModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		Prothese lToUpdate = (Prothese) this.getItem(Prothese.class);
		Prothese lUpdated = (Prothese) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
