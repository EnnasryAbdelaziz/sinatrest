...
*/
public class TuteurModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		Tuteur lToUpdate = (Tuteur) this.getItem(Tuteur.class);
		Tuteur lUpdated = (Tuteur) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
