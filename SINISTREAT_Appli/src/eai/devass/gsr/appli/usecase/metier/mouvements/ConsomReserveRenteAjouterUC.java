...
*/
public class ConsomReserveRenteAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		ConsomReserveRente lToCreate = (ConsomReserveRente) this.getItem(ConsomReserveRente.class);
		// Ici Je persiste l' entite ConsomReserveRente au niveau de la base de donnees
		ConsomReserveRente lCreated = (ConsomReserveRente) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
