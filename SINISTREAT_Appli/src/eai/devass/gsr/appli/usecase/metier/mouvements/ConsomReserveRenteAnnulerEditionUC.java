...
*/
public class ConsomReserveRenteAnnulerEditionUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		lToEdit = (ConsomReserveRente)lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
