...
*/
public class ConsomReserveRenteConsulterUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		ConsomReserveRente lToEdit = (ConsomReserveRente) this.getItem(ConsomReserveRente.class);
		ConsomReserveRente lEdited = (ConsomReserveRente) lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
