...
*/
public class ConsomReserveRenteModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		ConsomReserveRente lToUpdate = (ConsomReserveRente) this.getItem(ConsomReserveRente.class);
		ConsomReserveRente lUpdated = (ConsomReserveRente) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
