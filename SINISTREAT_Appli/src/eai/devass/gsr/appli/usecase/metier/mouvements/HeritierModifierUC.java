...
*/
public class HeritierModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		Heritier lToUpdate = (Heritier) this.getItem(Heritier.class);
		Heritier lUpdated = (Heritier) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
