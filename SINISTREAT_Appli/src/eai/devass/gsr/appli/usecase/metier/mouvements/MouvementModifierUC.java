...
*/
public class MouvementModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		Mouvement lUpdated = (Mouvement) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
