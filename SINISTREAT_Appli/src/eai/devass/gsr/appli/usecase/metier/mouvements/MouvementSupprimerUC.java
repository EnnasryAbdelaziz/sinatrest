...
/**
Service de supprission (logique) d' une entitÃ©
@author Nom Prenom (email)
*/
public class MouvementSupprimerUC extends FacadeServiceUseCase {

/**
Methode qui execute le use case de supprission (logique) d' un objet
@param entite l' objet Ã  supprimer
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		// mettre etat de l'entité en supprission ainsi ajouter la dates de la supprission
