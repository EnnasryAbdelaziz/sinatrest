...
*/
public class CentreProtheseAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		CentreProthese lToCreate = (CentreProthese) this.getItem(CentreProthese.class);
		// Ici Je persiste l' entite CentreProthese au niveau de la base de donnees
		CentreProthese lCreated = (CentreProthese) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
