...
*/
public class CentreProtheseConsulterUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		CentreProthese lToEdit = (CentreProthese) this.getItem(CentreProthese.class);
		CentreProthese lEdited = (CentreProthese) lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
