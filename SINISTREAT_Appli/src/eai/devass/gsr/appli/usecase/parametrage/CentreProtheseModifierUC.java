...
*/
public class CentreProtheseModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		CentreProthese lToUpdate = (CentreProthese) this.getItem(CentreProthese.class);
		CentreProthese lUpdated = (CentreProthese) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
