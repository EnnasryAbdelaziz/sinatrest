...
*/
public class EtatMvtAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		EtatMvt lToCreate = (EtatMvt) this.getItem(EtatMvt.class);
		// Ici Je persiste l' entite EtatMvt au niveau de la base de donnees
		EtatMvt lCreated = (EtatMvt) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
