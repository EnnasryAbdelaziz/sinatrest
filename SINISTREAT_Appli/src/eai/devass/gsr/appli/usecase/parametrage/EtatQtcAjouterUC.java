...
*/
public class EtatQtcAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		EtatQtc lToCreate = (EtatQtc) this.getItem(EtatQtc.class);
		// Ici Je persiste l' entite EtatQtc au niveau de la base de donnees
		EtatQtc lCreated = (EtatQtc) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
