 ...
 */
public class EtatRentierAjouterUC extends FacadeServiceUseCase {
	...
	protected void doExecuter(IValueObject entite, HashMap params)
		...
		EtatRentier lToCreate = (EtatRentier) this.getItem(EtatRentier.class);
		// Ici Je persiste l' entite EtatRentier au niveau de la base de donnees
		EtatRentier lCreated = (EtatRentier) lToCreate.getFactory()
