...
*/
public class EtatRentierModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		EtatRentier lToUpdate = (EtatRentier) this.getItem(EtatRentier.class);
		EtatRentier lUpdated = (EtatRentier) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
