 ...
 */
public class ModeReglementAjouterUC extends FacadeServiceUseCase {
	...
	protected void doExecuter(IValueObject entite, HashMap params)
		...
		ModeReglement lToCreate = (ModeReglement) this
				.getItem(ModeReglement.class);
		// Ici Je persiste l' entite ModeReglement au niveau de la base de
		// donnees
		ModeReglement lCreated = (ModeReglement) lToCreate.getFactory()
