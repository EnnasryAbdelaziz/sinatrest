...
*/
public class ModeReglementConsulterUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		ModeReglement lToEdit = (ModeReglement) this.getItem(ModeReglement.class);
		ModeReglement lEdited = (ModeReglement) lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
