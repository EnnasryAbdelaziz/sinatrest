...
*/
public class ModeReglementModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		ModeReglement lToUpdate = (ModeReglement) this.getItem(ModeReglement.class);
		ModeReglement lUpdated = (ModeReglement) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
