...
import eai.devass.gsr.appli.manager.parametrage.ModeReglementManager;
/**
Service de recherche d' une entité
@author Nom Prenom (email)
*/
public class ModeReglementRechercherUC extends RechListeUseCase {
...
*/
	public IEntiteManager getManager() {
		return new ModeReglementManager();
	}
