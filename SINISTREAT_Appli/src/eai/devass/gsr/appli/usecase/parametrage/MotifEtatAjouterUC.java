...
*/
public class MotifEtatAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		MotifEtat lToCreate = (MotifEtat) this.getItem(MotifEtat.class);
		// Ici Je persiste l' entite MotifEtat au niveau de la base de donnees
		MotifEtat lCreated = (MotifEtat) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
