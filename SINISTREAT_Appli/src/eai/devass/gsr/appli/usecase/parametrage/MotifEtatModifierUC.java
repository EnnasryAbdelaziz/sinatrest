...
*/
public class MotifEtatModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		MotifEtat lToUpdate = (MotifEtat) this.getItem(MotifEtat.class);
		MotifEtat lUpdated = (MotifEtat) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
