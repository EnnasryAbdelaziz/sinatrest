 ...
 */
public class MotifEtatModifierUCConverter extends MotifEtatVOConverter {
	/**
	...
	protected void doValider(MotifEtatVO vo) throws ValidationException {
		...
		try {
            validationUnitaire.validateField(sinistreAT, "motifEtat.code",
					vo.getCode());
            validationUnitaire.validateField(sinistreAT, "motifEtat.libelle",
					vo.getLibelle());
            validationUnitaire.validateField(sinistreAT,
					"motifEtat.dateCreation", vo.getDateCreation());
