...
*/
public class NatureQtcGsrAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		NatureQtcGsr lToCreate = (NatureQtcGsr) this.getItem(NatureQtcGsr.class);
		// Ici Je persiste l' entite NatureQuittance au niveau de la base de donnees
		NatureQtcGsr lCreated = (NatureQtcGsr) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
