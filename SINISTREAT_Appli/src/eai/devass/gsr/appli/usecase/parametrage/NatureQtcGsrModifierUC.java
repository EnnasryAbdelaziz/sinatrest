...
*/
public class NatureQtcGsrModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		NatureQtcGsr lToUpdate = (NatureQtcGsr) this.getItem(NatureQtcGsr.class);
		NatureQtcGsr lUpdated = (NatureQtcGsr) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
