...
*/
public class TypeActionAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeAction lToCreate = (TypeAction) this.getItem(TypeAction.class);
		// Ici Je persiste l' entite TypeAction au niveau de la base de donnees
		TypeAction lCreated = (TypeAction) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
