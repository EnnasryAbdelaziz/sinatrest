...
*/
public class TypeActionModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeAction lToUpdate = (TypeAction) this.getItem(TypeAction.class);
		TypeAction lUpdated = (TypeAction) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
