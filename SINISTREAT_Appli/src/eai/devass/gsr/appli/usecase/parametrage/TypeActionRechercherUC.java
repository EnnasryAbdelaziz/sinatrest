...
import eai.devass.gsr.appli.manager.parametrage.TypeActionManager;
/**
Service de recherche d' une entité
@author Nom Prenom (email)
*/
public class TypeActionRechercherUC extends RechListeUseCase {
