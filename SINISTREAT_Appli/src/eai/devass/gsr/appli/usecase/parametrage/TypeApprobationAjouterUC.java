...
*/
public class TypeApprobationAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeApprobation lToCreate = (TypeApprobation) this.getItem(TypeApprobation.class);
		// Ici Je persiste l' entite TypeApprobation au niveau de la base de donnees
		TypeApprobation lCreated = (TypeApprobation) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
