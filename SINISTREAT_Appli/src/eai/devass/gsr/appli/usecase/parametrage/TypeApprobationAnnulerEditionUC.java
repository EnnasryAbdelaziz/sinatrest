...
*/
public class TypeApprobationAnnulerEditionUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		lToEdit = (TypeApprobation)lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
