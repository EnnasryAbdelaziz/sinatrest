...
*/
public class TypeApprobationConsulterUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		TypeApprobation lToEdit = (TypeApprobation) this.getItem(TypeApprobation.class);
		TypeApprobation lEdited = (TypeApprobation) lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
