...
*/
public class TypeApprobationModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeApprobation lToUpdate = (TypeApprobation) this.getItem(TypeApprobation.class);
		TypeApprobation lUpdated = (TypeApprobation) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
