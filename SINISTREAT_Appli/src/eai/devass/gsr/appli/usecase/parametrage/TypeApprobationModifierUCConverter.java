 ...
 */
public class TypeApprobationModifierUCConverter extends
		TypeApprobationVOConverter {
	/**
	...
	protected void doValider(TypeApprobationVO vo) throws ValidationException {
		...
		try {
			validationUnitaire.validateField("sinistreAT",
					"typeApprobation.code", vo.getCode());
			validationUnitaire.validateField("sinistreAT",
					"typeApprobation.libelle", vo.getLibelle());
			validationUnitaire.validateField("sinistreAT",
					"typeApprobation.dateCreation", vo.getDateCreation());
