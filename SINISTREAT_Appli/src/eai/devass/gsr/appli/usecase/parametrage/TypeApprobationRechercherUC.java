...
import eai.devass.gsr.appli.manager.parametrage.TypeApprobationManager;
/**
Service de recherche d' une entité
@author Nom Prenom (email)
*/
public class TypeApprobationRechercherUC extends RechListeUseCase {
...
*/
	public IEntiteManager getManager() {
		return new TypeApprobationManager();
	}
