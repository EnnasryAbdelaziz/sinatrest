...
*/
public class TypeCertificatConsulterUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		TypeCertificat lToEdit = (TypeCertificat) this.getItem(TypeCertificat.class);
		TypeCertificat lEdited = (TypeCertificat) lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
