...
*/
public class TypeCertificatModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeCertificat lToUpdate = (TypeCertificat) this.getItem(TypeCertificat.class);
		TypeCertificat lUpdated = (TypeCertificat) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
