...
import eai.devass.gsr.appli.manager.parametrage.TypeCertificatManager;
/**
Service de recherche d' une entité
@author Nom Prenom (email)
*/
public class TypeCertificatRechercherUC extends RechListeUseCase {
...
*/
	public IEntiteManager getManager() {
		return new TypeCertificatManager();
	}
