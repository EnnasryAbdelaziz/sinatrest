...
*/
public class TypeChequeAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeCheque lToCreate = (TypeCheque) this.getItem(TypeCheque.class);
		// Ici Je persiste l' entite TypeCheque au niveau de la base de donnees
		TypeCheque lCreated = (TypeCheque) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
