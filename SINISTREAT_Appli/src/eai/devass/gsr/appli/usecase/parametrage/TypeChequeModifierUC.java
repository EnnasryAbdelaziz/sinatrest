...
*/
public class TypeChequeModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeCheque lToUpdate = (TypeCheque) this.getItem(TypeCheque.class);
		TypeCheque lUpdated = (TypeCheque) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
