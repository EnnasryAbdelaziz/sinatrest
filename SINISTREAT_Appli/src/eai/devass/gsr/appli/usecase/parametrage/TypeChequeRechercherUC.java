...
import eai.devass.gsr.appli.manager.parametrage.TypeChequeManager;
/**
Service de recherche d' une entité
@author Nom Prenom (email)
*/
public class TypeChequeRechercherUC extends RechListeUseCase {
