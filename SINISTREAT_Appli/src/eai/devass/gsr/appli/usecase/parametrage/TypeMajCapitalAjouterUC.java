...
*/
public class TypeMajCapitalAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeMajCapital lToCreate = (TypeMajCapital) this.getItem(TypeMajCapital.class);
		// Ici Je persiste l' entite TypeMajCapital au niveau de la base de donnees
		TypeMajCapital lCreated = (TypeMajCapital) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
