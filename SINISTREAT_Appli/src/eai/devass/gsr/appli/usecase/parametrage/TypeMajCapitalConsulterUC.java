...
*/
public class TypeMajCapitalConsulterUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		TypeMajCapital lToEdit = (TypeMajCapital) this.getItem(TypeMajCapital.class);
		TypeMajCapital lEdited = (TypeMajCapital) lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
