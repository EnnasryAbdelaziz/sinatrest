...
*/
public class TypeMajCapitalModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeMajCapital lToUpdate = (TypeMajCapital) this.getItem(TypeMajCapital.class);
		TypeMajCapital lUpdated = (TypeMajCapital) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
