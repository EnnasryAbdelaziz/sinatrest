...
*/
public class TypeMouvementAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeMouvement lToCreate = (TypeMouvement) this.getItem(TypeMouvement.class);
		// Ici Je persiste l' entite TypeMouvement au niveau de la base de donnees
		TypeMouvement lCreated = (TypeMouvement) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
