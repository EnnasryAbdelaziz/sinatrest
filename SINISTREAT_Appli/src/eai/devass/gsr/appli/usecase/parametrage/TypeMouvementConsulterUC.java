...
*/
public class TypeMouvementConsulterUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeMouvement lEdited = (TypeMouvement) lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
