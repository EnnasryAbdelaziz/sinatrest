...
*/
public class TypeMouvementModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeMouvement lToUpdate = (TypeMouvement) this.getItem(TypeMouvement.class);
		TypeMouvement lUpdated = (TypeMouvement) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
