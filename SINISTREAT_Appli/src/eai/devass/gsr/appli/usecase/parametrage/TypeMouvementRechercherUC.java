...
import eai.devass.gsr.appli.manager.parametrage.TypeMouvementManager;
/**
Service de recherche d' une entité
@author Nom Prenom (email)
*/
public class TypeMouvementRechercherUC extends RechListeUseCase {
...
*/
	public IEntiteManager getManager() {
		return new TypeMouvementManager();
	}
