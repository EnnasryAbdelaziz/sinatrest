...
*/
public class TypeMvtProtheseAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeMvtProthese lToCreate = (TypeMvtProthese) this.getItem(TypeMvtProthese.class);
		// Ici Je persiste l' entite TypeMvtProthese au niveau de la base de donnees
		TypeMvtProthese lCreated = (TypeMvtProthese) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
