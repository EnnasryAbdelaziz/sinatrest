...
*/
public class TypeMvtProtheseAnnulerEditionUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		lToEdit = (TypeMvtProthese)lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
