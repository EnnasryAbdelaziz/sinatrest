...
*/
public class TypeMvtProtheseConsulterUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		TypeMvtProthese lToEdit = (TypeMvtProthese) this.getItem(TypeMvtProthese.class);
		TypeMvtProthese lEdited = (TypeMvtProthese) lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
