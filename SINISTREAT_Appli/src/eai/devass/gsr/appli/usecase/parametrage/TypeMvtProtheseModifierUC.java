...
*/
public class TypeMvtProtheseModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeMvtProthese lToUpdate = (TypeMvtProthese) this.getItem(TypeMvtProthese.class);
		TypeMvtProthese lUpdated = (TypeMvtProthese) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
