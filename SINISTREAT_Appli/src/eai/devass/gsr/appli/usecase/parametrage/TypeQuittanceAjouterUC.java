...
*/
public class TypeQuittanceAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeQuittance lToCreate = (TypeQuittance) this.getItem(TypeQuittance.class);
		// Ici Je persiste l' entite TypeQuittance au niveau de la base de donnees
		TypeQuittance lCreated = (TypeQuittance) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
