...
*/
public class TypeQuittanceConsulterUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		TypeQuittance lToEdit = (TypeQuittance) this.getItem(TypeQuittance.class);
		TypeQuittance lEdited = (TypeQuittance) lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
