...
*/
public class TypeQuittanceModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeQuittance lToUpdate = (TypeQuittance) this.getItem(TypeQuittance.class);
		TypeQuittance lUpdated = (TypeQuittance) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
