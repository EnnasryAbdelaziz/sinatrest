...
import eai.devass.gsr.appli.manager.parametrage.TypeQuittanceManager;
/**
Service de recherche d' une entité
@author Nom Prenom (email)
*/
public class TypeQuittanceRechercherUC extends RechListeUseCase {
...
*/
	public IEntiteManager getManager() {
		return new TypeQuittanceManager();
	}
