...
*/
public class TypeRecuperationAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeRecuperation lToCreate = (TypeRecuperation) this.getItem(TypeRecuperation.class);
		// Ici Je persiste l' entite TypeRecuperation au niveau de la base de donnees
		TypeRecuperation lCreated = (TypeRecuperation) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
