...
*/
public class TypeRecuperationAnnulerEditionUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		lToEdit = (TypeRecuperation)lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
