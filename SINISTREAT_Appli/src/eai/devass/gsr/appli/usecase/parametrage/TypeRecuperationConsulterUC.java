...
*/
public class TypeRecuperationConsulterUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		TypeRecuperation lToEdit = (TypeRecuperation) this.getItem(TypeRecuperation.class);
		TypeRecuperation lEdited = (TypeRecuperation) lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
