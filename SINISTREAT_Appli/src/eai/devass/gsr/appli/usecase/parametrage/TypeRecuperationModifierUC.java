...
*/
public class TypeRecuperationModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeRecuperation lToUpdate = (TypeRecuperation) this.getItem(TypeRecuperation.class);
		TypeRecuperation lUpdated = (TypeRecuperation) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
