...
import eai.devass.gsr.appli.manager.parametrage.TypeRecuperationManager;
/**
Service de recherche d' une entité
@author Nom Prenom (email)
*/
public class TypeRecuperationRechercherUC extends RechListeUseCase {
...
*/
	public IEntiteManager getManager() {
		return new TypeRecuperationManager();
	}
