...
*/
public class TypeRgltGsrAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeRgltGsr lToCreate = (TypeRgltGsr) this.getItem(TypeRgltGsr.class);
		// Ici Je persiste l' entite TypeReglement au niveau de la base de donnees
		TypeRgltGsr lCreated = (TypeRgltGsr) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
