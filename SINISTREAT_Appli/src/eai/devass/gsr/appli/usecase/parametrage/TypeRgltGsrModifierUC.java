...
*/
public class TypeRgltGsrModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeRgltGsr lToUpdate = (TypeRgltGsr) this.getItem(TypeRgltGsr.class);
		TypeRgltGsr lUpdated = (TypeRgltGsr) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
