 ...
 */
public class TypeRgltGsrModifierUCConverter extends TypeRgltGsrVOConverter {
	/**
	...
	protected void doValider(TypeRgltGsrVO vo) throws ValidationException {
		...
		try {
			validationUnitaire.validateField("sinistreAT",
					"typeReglement.code", vo.getCode());
			validationUnitaire.validateField("sinistreAT",
					"typeReglement.libelle", vo.getLibelle());
			validationUnitaire.validateField("sinistreAT",
					"typeReglement.dateCreation", vo.getDateCreation());
