...
*/
public class TypeVirementAjouterUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeVirement lToCreate = (TypeVirement) this.getItem(TypeVirement.class);
		// Ici Je persiste l' entite TypeVirement au niveau de la base de donnees
		TypeVirement lCreated = (TypeVirement) lToCreate.getFactory().newEntiteManager().createEntite(lToCreate);
