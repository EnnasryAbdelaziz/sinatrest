...
*/
public class TypeVirementConsulterUC extends FacadeServiceUseCase {
/**
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeVirement lEdited = (TypeVirement) lToEdit.getFactory().newEntiteManager().getEntite(lToEdit);
