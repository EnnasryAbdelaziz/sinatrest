...
*/
public class TypeVirementModifierUC extends FacadeServiceUseCase {
...
*/
	protected void doExecuter(IValueObject entite, HashMap params) throws Exception {
		...
		TypeVirement lToUpdate = (TypeVirement) this.getItem(TypeVirement.class);
		TypeVirement lUpdated = (TypeVirement) lToUpdate.getFactory().newEntiteManager().modifyEntite(lToUpdate);
