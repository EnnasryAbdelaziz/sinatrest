 ...
 */
public class TypeVirementModifierUCConverter extends TypeVirementVOConverter {
	/**
	...
	protected void doValider(TypeVirementVO vo) throws ValidationException {
		...
		try {
			validationUnitaire.validateField("sinistreAT", "typeVirement.code",
					vo.getCode());
			validationUnitaire.validateField("sinistreAT",
					"typeVirement.libelle", vo.getLibelle());
			validationUnitaire.validateField("sinistreAT",
					"typeVirement.dateCreation", vo.getDateCreation());
