...
import eai.devass.gsr.appli.manager.parametrage.TypeVirementManager;
/**
Service de recherche d' une entité
@author Nom Prenom (email)
*/
public class TypeVirementRechercherUC extends RechListeUseCase {
...
*/
	public IEntiteManager getManager() {
		return new TypeVirementManager();
	}
