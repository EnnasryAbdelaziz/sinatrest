...
/**
 * Value Object de DossierRente
 * 
 * @author Mossâb wassim 
 */
public class DossierRenteVO extends EntiteVO implements ITracable {
	...
	private List<RentierVO> refsRentier;
	...
	public List<RentierVO> getRefsRentier() {
		return this.refsRentier;
	}

	public void setRefsRentier(List<RentierVO> refsRentier) {
