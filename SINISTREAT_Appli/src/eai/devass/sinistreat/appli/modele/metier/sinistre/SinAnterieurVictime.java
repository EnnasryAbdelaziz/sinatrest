...
@AConverter(entiteDist = "eai.devass.sinistreat.appli.valueobjects.metier.sinistre.SinAnterieurVictimeVO")
public class SinAnterieurVictime implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((refVictime == null) ? 0 : refVictime.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SinAnterieurVictime other = (SinAnterieurVictime) obj;
		...
		if (numeroSinistre == null) {
			...
			return false;
		if (refVictime == null) {
			if (other.refVictime != null)
				return false;
		} else if (!refVictime.equals(other.refVictime))
			return false;
		if (tauxIPP == null) {
