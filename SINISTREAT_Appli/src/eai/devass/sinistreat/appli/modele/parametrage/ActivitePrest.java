...
public class ActivitePrest implements java.io.Serializable {
	...
	public DomainePrest refDomaineActivite= new DomainePrest();
	/**
	 * Empty constructor which is required by Hibernate
	 * 
	 */
	public ActivitePrest() {
		
	}
	
	public ActivitePrest(String code) {
		this.code = code;
	}
