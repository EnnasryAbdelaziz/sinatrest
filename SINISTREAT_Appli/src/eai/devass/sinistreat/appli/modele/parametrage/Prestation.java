...
public class Prestation implements java.io.Serializable {
	...
	private String codePrestataionQtc;
	...
	public String getCodePrestataionQtc() {
		return codePrestataionQtc;
	}

	public void setCodePrestataionQtc(String codePrestataionQtc) {
		this.codePrestataionQtc = codePrestataionQtc;
	}
