...
public class Tribunal implements java.io.Serializable{
	...
	public void setRefType(TypeTribunal refType) {
		this.refType = refType;
	}

	public TypeTribunal getRefType() {
		return refType;
	}
	...
	/**
	 * @param refVille the refVille to set
	 */
