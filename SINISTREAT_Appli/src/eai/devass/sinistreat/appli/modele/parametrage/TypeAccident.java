...
@AConverter(entiteDist="eai.devass.sinistreat.appli.valueobjects.parametrage.TypeAccidentVO")
public class TypeAccident implements java.io.Serializable {
	...
	public TypeAccident(String code) {
		this.code = code;
	}
