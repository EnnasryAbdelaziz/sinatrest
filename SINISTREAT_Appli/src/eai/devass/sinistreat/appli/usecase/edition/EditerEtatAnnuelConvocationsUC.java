...
public class EditerEtatAnnuelConvocationsUC extends EditerEtatUC{
	...
	protected Map<String, Object> getRapportParametresValues(IValueObject vo) {
		...
		params.put("titre", "ETAT ANNUEL DES CONVOCATIONS");
		params.put("paramTraitement", "EXERCICE : " + editionVO.getDateDebut().substring(6));
