...
public class EditerListeControleRecuperationsParRedacteurUC extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_RAPPORT_LISTE_CONTROLE_RECUPERATIONS_PAR_REDACTEUR;
	}
