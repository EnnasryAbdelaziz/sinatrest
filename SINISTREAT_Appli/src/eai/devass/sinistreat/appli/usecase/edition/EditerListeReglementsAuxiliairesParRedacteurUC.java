...
public class EditerListeReglementsAuxiliairesParRedacteurUC extends EditerEtatUC{
	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_RAPPORT_LISTE_REGLEMENTS_AUXILIAIRES_PAR_REDACTEUR;
	}
	...
	protected Map<String, Object> getRapportParametresValues(IValueObject vo) {
		...
		params.put("redacteur", "REDACTEUR : " + editionVO.getNomUtilisateur());
		params.put("codeRedacteur", editionVO.getUtilisateur());
