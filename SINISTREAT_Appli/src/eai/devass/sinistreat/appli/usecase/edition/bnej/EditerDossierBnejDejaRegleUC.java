...
public class EditerDossierBnejDejaRegleUC extends EditerJrxmlUC {

	@Override
	protected String getCodeTemplate() {
		return IConstantes.CODE_TEMPLATE_EDITION_BNEJ_DEJA_REGLE;
	}
	...
	protected Map<String, Object> getRapportParametresValues(IValueObject vo) {
		...
		params.put("LIBELLE_DECISION",bnejManager.getTypeDecisionBnejLibelle(editionVO.getDecision()));
