...
public class EditerEtatControleConciliationsAvecResultatAccepterUC extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_RAPPORT_ETAT_CONTROLE_CONCILIATION_AVEC_RESULTAT_ACCEPTER;
	}
