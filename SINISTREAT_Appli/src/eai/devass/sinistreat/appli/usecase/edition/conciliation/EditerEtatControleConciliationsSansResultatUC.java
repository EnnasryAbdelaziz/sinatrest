...
public class EditerEtatControleConciliationsSansResultatUC extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_RAPPORT_ETAT_CONTROLE_CONCILIATION_SANS_RESULTAT;
	}
