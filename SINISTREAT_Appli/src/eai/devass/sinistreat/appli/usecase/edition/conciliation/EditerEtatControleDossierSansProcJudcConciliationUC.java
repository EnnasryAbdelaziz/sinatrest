...
public class EditerEtatControleDossierSansProcJudcConciliationUC extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_RAPPORT_ETAT_CONTROLE_DOSSIERS_SANS_PROCJUDIC_CONCILIATION;
	}
