...
public class EditerEtatAssignationsJudiciairesParAvocatConseil extends EditerEtatUC{
	...
	protected Map<String, Object> getRapportParametresValues(IValueObject vo) {
		...
		params.put("byAvocatConseil", "1");
		params.put("codeAvocatConseil", editionVO.getMode());
