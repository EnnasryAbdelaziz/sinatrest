...
public class EditerEtatDossiersEvtsAtteignantPrioriteReassuranceUC extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_ETAT_DOSSIERS_EVTS_ATTEIGNANT_PRIORITE_REASSURANCE;
	}
