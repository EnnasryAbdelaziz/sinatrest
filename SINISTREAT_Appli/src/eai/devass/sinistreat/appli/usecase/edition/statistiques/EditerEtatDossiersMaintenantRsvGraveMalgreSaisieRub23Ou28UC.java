...
public class EditerEtatDossiersMaintenantRsvGraveMalgreSaisieRub23Ou28UC extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_ETAT_DOSSIERS_MAINTENANT_RSV_GRAVE_MALGRE_SAISIE_RUB23OU28;
	}
