...
public class EditerEtatSinistresDossiersOrdinairesUC extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_ETAT_SINISTRES_DOSSIERS_ORDINAIRES;
	}
	...
	protected Map<String, Object> getRapportParametresValues(IValueObject vo) {
		...
		params.put("nomEdition", "EditerEtatSinistresDossiersOrdinaires");
