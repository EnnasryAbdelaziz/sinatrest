...
public class EditerEtatSinistresParExerciceEtTauxIPPUC extends EditerEtatUC{

	@Override
	protected String getCodeRapport() {
		return IConstantes.CODE_ETAT_SINISTRES_PAR_EXERCICE_ET_TAUXIPP;
	}
	...
	protected Map<String, Object> getRapportParametresValues(IValueObject vo) {
		...
		params.put("minima", editionVO.getMinima());
		params.put("maxima", editionVO.getMaxima());
		try {
