...
public class InitValidationReglementPositionnementUCConverter extends ValueObjectConverterAbst {
	...
	public Object doConvertItemsToValueObject(List listeItems) {
		...
		try {
			...
			List<ReglementVO> listReglementVO = (List<ReglementVO>) ConverterTools.getInstance()
					.convertToListObjectVOWithoutList(listReglement);
			// Delegation
			Boolean delegation = (Boolean) listeItems.get(1);
			mapOut.put("isSup", delegation);	
