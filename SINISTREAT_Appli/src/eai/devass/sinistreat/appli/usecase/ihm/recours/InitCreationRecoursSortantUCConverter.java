...
public class InitCreationRecoursSortantUCConverter extends ValueObjectConverterAbst {
	...
	public Object doConvertItemsToValueObject(List listeItems) {
		...
		try {
			...
			List typeAccidentVO = converterTools.convertToListObjectVO(listTypeAccident);
			...
			map.put("listTypeAccident", typeAccidentVO);	
