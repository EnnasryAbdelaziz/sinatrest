...
public class AjouterListeCertificatUCConverter extends ValueObjectConverterAbst
	...
	public Object doConvertItemsToValueObject(List listeItems) {
		try {
			List<CertificatMedical> listCertificatMedical = (List<CertificatMedical>) listeItems.get(0);
			List<CertificatMedicalVO> listCertificats;
			listCertificats = (List<CertificatMedicalVO>) converterTools.convertToListObjectVO(listCertificatMedical);
	...
	public List doConvertValueObjectToItems(Object vo)
		...
		try {
			...
			List<CertificatMedical> listCertificats = (List<CertificatMedical>) converterTools.convertToListObjectBO(listCertificatMedicalVO);
			return listCertificats;
		} catch (Exception e) {
