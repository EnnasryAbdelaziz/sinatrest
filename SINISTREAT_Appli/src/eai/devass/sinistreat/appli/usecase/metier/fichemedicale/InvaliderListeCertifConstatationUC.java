...
public class InvaliderListeCertifConstatationUC extends BaseUC {
	...
	protected void executerUC(IValueObject entite, HashMap params)
		...
		try {
			if(certificatMedicalManager.invaliderCertificatParId(certificatMedical)) {
				addResultItem(new InfoMessageItem("SUCCES_INVALIDER_CERTIFICAT"));
			} else {
