...
public class ModifierCertificatMedicalUCConverter extends  ValueObjectConverterAbst
	...
	public Object doConvertItemsToValueObject(List listeItems) {
		...
		try {
			...
			certificatMedicalVO = (CertificatMedicalVO)ConverterTools.getInstance().convertToObjectVOWithoutList(certificatMedical);
