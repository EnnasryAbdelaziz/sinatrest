...
public class RechercheCertificatMedicalHistoriqueUC extends BaseUC{

	@Override
	protected void executerUC(IValueObject entite, HashMap params)
			throws Exception {
		// TODO Auto-generated method stub
		List<CertificatMedicalHistorique> listCertificatMedical = null;
		...
		try{
			...
			listCertificatMedical=(List)certificatMedicalManager.getHistoriqueCertificat(certificatMedical);
