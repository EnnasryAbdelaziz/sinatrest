...
public class RechercheDernierCertificatMedicalUC extends BaseUC{
	...
	protected void executerUC(IValueObject entite, HashMap params)
		...
		try{
			...
			listCertificatMedical=(List)certificatMedicalManager.getListDerniersCertificat(certificatMedical);
