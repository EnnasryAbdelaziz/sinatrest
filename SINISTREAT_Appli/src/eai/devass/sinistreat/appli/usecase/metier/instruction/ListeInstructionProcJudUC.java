...
public class ListeInstructionProcJudUC extends BaseUC {
	...
	protected void executerUC(IValueObject entite, HashMap params)
		...
		if (pagerVO != null && pagerVO.getNbrLignes() != null) {
			...
			if ("1".equals(pagerVO.getNbrLignes())) {
				Integer nbreObject = instructionManager.getNombreInstructionByIdProcJud(i);
		...
		List<Instruction> listInstruction = instructionManager.getInstructionByIdProcJud(i, pagerVO);
