...
public class PreEditerInstructionUCConverter extends ValueObjectConverterAbst
		implements IMessageException {

	private Logger logger = Logger.getLogger("loggerSINAT");

	public PreEditerInstructionUCConverter() {
    ...
    public Object doConvertItemsToValueObject(List listeItems)
    {
        ...
        try
        {
        	...
        	instVo = (InstructionVO)converterTools.convertToObjectVO(instruction);
        }
        catch(Exception e)
        {
