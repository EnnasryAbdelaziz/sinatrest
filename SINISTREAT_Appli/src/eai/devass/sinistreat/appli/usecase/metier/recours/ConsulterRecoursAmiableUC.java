...
public class ConsulterRecoursAmiableUC extends BaseUC {

	protected void executerUC(IValueObject entite, HashMap params)
			throws Exception {
		
		RecoursAmiable recours = (RecoursAmiable) this.getItem(RecoursAmiable.class);

		RecoursAmiable recoursResult = null;
		try {
			recoursResult = (RecoursAmiable) recoursManager
					.consulterRecoursAmiable(recours);
