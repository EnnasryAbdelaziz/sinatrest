...
public class ConsulterRecoursRsUC extends BaseUC {

	protected void executerUC(IValueObject entite, HashMap params)
			throws Exception {
		Recours recoursSortant = (Recours) this.getItem(Recours.class);

		Recours rRecours = null;
		try {
			rRecours = (Recours) recoursManager
					.consulterRecours(recoursSortant);
