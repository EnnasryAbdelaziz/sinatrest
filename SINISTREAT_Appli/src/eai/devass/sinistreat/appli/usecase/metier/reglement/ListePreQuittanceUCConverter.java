...
public class ListePreQuittanceUCConverter extends ValueObjectConverterAbst {
	...
	public Object doConvertItemsToValueObject(List listeItems) {
		...
		try {
			...
			reglement.setPropertiesToConvert(new String[] { "id",
					...
					"avocatTiers ", "referenceAuxiliaire", "nomMandataire",
					"codeMandataire","codeChefGreffier","nomChefGreffier",
