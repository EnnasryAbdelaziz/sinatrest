...
public class RecherchePreQuittanceARisqueUCConverter extends ValueObjectConverterAbst
		...
		if (reglement instanceof Reglement) {
			((Reglement) reglement)
					.setPropertiesToConvert(new String[] {
							...
							"refEtatReglement.code", "refSinistre.id","refSinistre.nomClient",
							...
							"nomBeneficiaireLettre", "typeBeneficiaireLettre", "dateReception", "refProcedure","codeUserCreateur","nomUserCreateur"});
