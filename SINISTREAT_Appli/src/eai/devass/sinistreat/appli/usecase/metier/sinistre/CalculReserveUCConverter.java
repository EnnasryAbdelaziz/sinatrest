...
public class CalculReserveUCConverter extends ValueObjectConverterAbst
	...
	public List doConvertValueObjectToItems(Object vo)
		...
		try {
			...
			if (even != null && vic != null) {
				...
				if (sin.getDateDeclaration() == null) {
					throw new FonctionnelleException(EXP_DATE_DECLARATION);
				}
