...
public class GetQuittanceByIdUC extends BaseUC {
	...
	protected void executerUC(IValueObject entite, HashMap params) throws Exception {
		...
		try {
			ChQResult = (CourrierHybrideQuittance) parametrageManager.getCourrierHybrideQuittanceByIdLRH(courrierQuittanceHybride.getIdLRH());
