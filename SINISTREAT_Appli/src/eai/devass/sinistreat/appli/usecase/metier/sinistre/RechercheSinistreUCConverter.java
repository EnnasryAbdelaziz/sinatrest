...
public class RechercheSinistreUCConverter extends ValueObjectConverterAbst
	...
	public Object doConvertItemsToValueObject(List listeItems) {
		...
		//TODO: WMOS --> Cette méthode impacte la recherche sinistre dans le projet GSR
//			Sinistre sinistre = listSin.get(0);
//			sinistre.setPropertiesToConvert(new String[] {"numeroSinistre","refVictime.nomprenom","refEvenement.dateAccident",
//					"numeroPolice","nomClient","codeIntermediaire"});
			...
			if (listeItems.size() > 1) {
				...
				if (listSinvo != null && !listSinvo.isEmpty()) {
					map.put("list"
							+ listSinvo.get(0).getClass().getSimpleName(),
							listSinvo);
				}
