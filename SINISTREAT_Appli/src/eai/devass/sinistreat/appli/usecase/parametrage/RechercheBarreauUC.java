...
public class RechercheBarreauUC extends BaseUC {

	@SuppressWarnings("unchecked")
	protected void executerUC(IValueObject entite, HashMap params)
			throws Exception {

		List<Barreau> listeBarreau = null;
		PagerVO pagerVO = (PagerVO) params.get(IParam.PAGER);
		Barreau barreau = (Barreau) this.getItem(Barreau.class);
		try {
			if (pagerVO != null) {
				...
				listeBarreau = (List) parametrageManager
						.getListBarreaux(barreau, pagerVO);
				Integer nbreObject = parametrageManager
						.getNombreBarreaux(barreau);
