...
public class NatureEcheanceVO extends ParamATVO implements IValueObject {
	
	@Validate(obligatoire=true)
	private String code;
	private String libelle;
	
	public NatureEcheanceVO() {
		
	}
	public NatureEcheanceVO(String code) {
		this.code = code;
	}
	public NatureEcheanceVO(String code, String libelle) {
		this.code = code;
