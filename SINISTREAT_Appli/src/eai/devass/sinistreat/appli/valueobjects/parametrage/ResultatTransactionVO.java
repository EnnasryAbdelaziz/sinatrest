...
public class ResultatTransactionVO implements IValueObject {
	
	@Validate(obligatoire=true)
	private String code;
	private String libelle;
	
	public ResultatTransactionVO() {
		
	}
	public ResultatTransactionVO(String code) {
		this.code = code;
	}
	public ResultatTransactionVO(String code, String libelle) {
		this.code = code;
