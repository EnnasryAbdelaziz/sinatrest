...
public class TypeCertificatVO implements IValueObject {
	private String id;
	@Validate(obligatoire=true)
	private String code;
	private String libelle;
	
	public TypeCertificatVO() {
		
	}
	public TypeCertificatVO(String code) {
		this.code = code;
	}
	public TypeCertificatVO(String code, String libelle) {
		this.code = code;
