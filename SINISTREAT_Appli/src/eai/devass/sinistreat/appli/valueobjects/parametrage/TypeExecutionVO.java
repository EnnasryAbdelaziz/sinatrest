...
public class TypeExecutionVO implements IValueObject {
	
	@Validate(obligatoire=true)
	private String code;
	private String libelle;
	
	public TypeExecutionVO() {
		
	}
	public TypeExecutionVO(String code) {
		this.code = code;
	}
	public TypeExecutionVO(String code, String libelle) {
		this.code = code;
