					...
					<tr bgcolor="#D3D7DE">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="397"><form method="post" action="habLogonAction.do">
									<table width="304" border="0" align="center" cellpadding="2"
										...
										<tr>
											...
											<td valign="top"><input type="text" name="login" maxlength="19" value="login" /></td>
											<td width="17">&nbsp;</td>
										</tr>
										<tr>
											<td height="25" valign="middle">Mot de passe</td>
											<td valign="top"><input type="password" name="motdepasse" value="pass" onkeydown="if (event.keyCode == 13) onSubmit();"
												maxlength="8" /></td>
