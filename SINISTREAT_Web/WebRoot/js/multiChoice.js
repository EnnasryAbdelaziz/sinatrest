...
function MoveUp()
{
	ShiftListSelections(document.forms[0].freeOptionsList, false);
}

function MoveDown()
{
	ShiftListSelections(document.forms[0].freeOptionsList, true);
}

/* 
** Add the selected fields form the freefields listbox into the
** usedfields listbox, then remove them form the freefields listbox
*/
function AddFields(usedOptionsListName) {
	MoveSelectedListItems(document.forms[0].elements[usedOptionsListName],document.forms[0].freeOptionsList, false);
...
function RemoveFields(usedOptionsListName) {
	MoveSelectedListItems(document.forms[0].freeOptionsList,document.forms[0].elements[usedOptionsListName],true);
	//Force a refresh to keeps netscape happy.
	if (browser=="ns") history.go(0);
}
...
function selectAllOptions(listName)
{
	var li = document.forms[0].elements[listName];
