--Entete
insert into SIN_ENTETE(id, sous_titre) values(6, null);
 
insert into SIN_LIGNE_TITRE(id, libelle, id_sin_entete) values(7, 'LISTE DE CONTROLE DES REGLEMENTS DIRECTS', 6);

-- Recap generale
insert into SIN_RECAP(id, type_fille, description) values(2, 'RECAP_GENERALE', 'Summary Etat Liste de controle des reglements directs');

insert into SIN_RAPPORT(id, code, description, requete_sql, id_sin_template, id_sin_entete, id_sin_recap_generale)
values(6, '06', 'Liste des controles des reglements directs',
...
values(79, 'PARAMETRE', 'dateDebut', 'java.lang.String', 'DU : ', 1, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, ordre_affichage, id_sin_entete)
values(80, 'PARAMETRE', 'dateFin', 'java.lang.String', 'AU : ', 2, 6);
...
values(81, 'CHAMP', 'quittance', 'java.lang.String', 'N° Quittance', '', 'Center', 106, 1, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(82, 'CHAMP', 'date_reglement', 'java.sql.Timestamp', 'Date Régl.', 'dd/MM/yyyy', 'Center', 80, 2, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(83, 'CHAMP', 'numero_sinistre', 'java.lang.String', 'N° Sinistre', '', 'Center', 200, 3, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(84, 'CHAMP', 'numero_grave', 'java.lang.String', 'Grv.', '', 'Center', 34, 4, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(85, 'CHAMP', 'nom_beneficiaire', 'java.lang.String', 'Nom Bénéficiaire', '', 'Left', 200, 5, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(86, 'CHAMP', 'montant', 'java.lang.Double', 'Montant', '#,##0.00', 'Right', 75, 6, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(87, 'CHAMP', 'rubrique', 'java.lang.String', 'Rub.', '', 'Center', 30, 7, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(88, 'CHAMP', 'etat_anci', 'java.lang.String', 'Anc.E', '', 'Center', 35, 8, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(89, 'CHAMP', 'etat_nouv', 'java.lang.String', 'Nov.E', '', 'Center', 35, 9, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(90, 'CHAMP', 'reservegraveold', 'java.lang.Double', 'Anc.Rsv.Grv', '#,##0.00', 'Right', 75,10, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(91, 'CHAMP', 'reservegrave', 'java.lang.Double', 'Nov.Rsv.Grv', '#,##0.00', 'Right', 75, 11, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(92, 'CHAMP', 'reserveordold', 'java.lang.Double', 'Anc.Rsv.Ord', '#,##0.00', 'Right', 75, 12, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(93, 'CHAMP', 'reserveord', 'java.lang.Double', 'Nov.Rsv.Ord', '#,##0.00', 'Right', 75, 13, 6);

insert into SIN_RAPPORT_ELEMENT(id,type_fille, name, type, libelle, pattern, text_alignment, width, ordre_affichage, id_sin_rapport)
values(94, 'CHAMP', 'redacteur', 'java.lang.String', 'Rédacteur', '', 'Left', 80, 14, 6);
...
values (95, 'VARIABLE', 'nbreQuittances', 'java.lang.Integer', 'Nombre Total des Quittances : ', 'Left', 'Count', '$F{quittance}', 1, 2);                               
...
values (96, 'VARIABLE', 'totalMontantQuittance', 'java.lang.Double', 'Total Montant des Quittances : ', '#,##0.00', 'Right', 'Sum', '$F{montant}', 2, 2);                               
